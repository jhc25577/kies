# TODO: change the name of this file from elliptic to kyber or quantum
...
# TODO: I think we can just use the Kyber library encapsulation and decapsulation methods here...
def encapsulate(pk):
    k, ct = Kyber512.encaps(pk)
    return k, ct
